...
# Rename columns for the correlation calculation
df_corr = df_val[independent_vars].rename(columns=label_map_diag)

sns.heatmap(df_corr.corr(), annot=True, cmap='coolwarm', center=0, fmt='.2f')
plt.title('Correlation Matrix of Predictors (Norway)', fontsize=14, fontweight='bold')
